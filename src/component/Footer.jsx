...
const Footer = () => {
  ...
  const quickLinks = isAuthenticated ? appLinks : landingLinks;
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              {quickLinks.map((link) => (
                <li key={isAuthenticated ? link.path : link.id}>
                  {isAuthenticated ? (
                    <Link
                      to={link.path}
                    ...
                    <button
                      ...
                      className="hover:text-gray-300 transition duration-200 text-left w-full"
                    >
                      {link.label}
                    </button>
                  )}
          ...
          {/* Rest of your footer remains exactly the same */}
          <div>
            ...
            <div className="mt-6">
              ...
              <div className="flex">
                <input
                  ...
                  className="bg-gray-100 border-black border-2 text-black px-4 py-2 rounded-l-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 w-full"
                />
                <button className="bg-emerald-500 text-white hover:bg-emerald-600 px-4 py-2 rounded-r-lg transition-colors">
                  Subscribe
                </button>
              </div>
            </div>
