...
export default function PostCard({ post }) {
  ...
  const postMedia =
    post?.imageUrls?.length > 0
      ? [
          { type: "video", isLocked: true }, // fake video FIRST
        ...
        <div className="bg-white rounded-[22px] overflow-hidden">
          ...
          <div className="flex items-center justify-between p-4 border-b border-gray-100 cursor-default">
            ...
            {post.author._id === user?.id && (
              <button
                onClick={() => openPremium("priority_listing_post")}
              ...
              <div className="relative w-full h-64 overflow-hidden rounded-xl group">
                ...
                <img
                  ...
                  className={`absolute inset-0 w-full h-full object-cover transition-opacity duration-300 ${
                    postMedia[currentMediaIndex]?.type === "image"
                      ? "opacity-100"
                      : "opacity-0"
                  }`}
                />
                ...
                <div
                  ...
                  className={`absolute inset-0 flex items-center justify-center bg-gray-300 transition-opacity duration-300 ${
                ...
                >
                  ...
                  <div className="absolute top-3 left-3 bg-black/50 backdrop-blur-md text-white px-3 py-1 rounded-full flex items-center gap-2 text-xs border border-white/20">
                    <Play size={12} />
                    PRO
                  </div>
                </div>
